...
public class SecureItemNoteFragment extends SecureItemFragment {
    @Bind(R.id.fr_si_name)
    @NotEmpty(messageId = R.string.RequiredField, order = 1)
    EditText mNameView;
    @Bind(R.id.fr_sint_note)
    EditText mNoteView;
    ...
    @Override
    int getTypeLayoutId() {
        return R.layout.fragment_secure_item_note;
    }
    ...
    protected void populateData(@NonNull SecureItem item, @NonNull SecureItemProperties properties) {
        ...
        properties.setString(Identifier.NOTES, mNoteView);
    }
    ...
    public void populateViews(@NonNull SecureItem item, @NonNull SecureItemProperties properties) {
        ...
        mNoteView.setText(properties.getString(Identifier.NOTES));
    }
