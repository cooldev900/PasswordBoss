...
public class SecureItemInstantMessengerFragment extends SecureItemFragment {
    ...
    protected ItemType getItemType() {
        return ItemType.InstantMessenger;
    }

    @Override
    int getTypeLayoutId() {
        return R.layout.fragment_secure_item_instant_messenger;
    }
